<html style=""><head>
    ...
    <link href="<?=base_url()?>assets/profile.css" media="all" rel="stylesheet" type="text/css">
    <link href="<?=base_url()?>assets/profile2.css" media="all" rel="stylesheet" type="text/css">
      <script type="text/javascript" async="" src="https://ssl.google-analytics.com/ga.js"></script>
  </head>
  <body class="logged_in page-profile mine macintosh  env-production " style="">

    <div class="wrapper">
        <div class="site clearfix">
          <div id="site-container" class="context-loader-container" data-pjax-container="">
<div class="container">
  <div class="columns profilecols js-username" data-name="sebakan">
      ...
      <div class="first vcard" itemscope="" itemtype="http://schema.org/Person">
        ...
        -->
          <li>
              <a href="/stars">
                <strong>0</strong>
                <span>entregas<br>pendientes</span>
              </a>
          </li>
          <li>
          </li>
